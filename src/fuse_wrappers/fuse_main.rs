...
use crate::fuse_wrappers::{
    bindings::{
        ...
        fuse_loop_cfg_set_clone_fd, fuse_loop_cfg_set_max_threads, fuse_lowlevel_ops,
        fuse_opt_free_args, fuse_parse_cmdline, fuse_remove_signal_handlers, fuse_session,
