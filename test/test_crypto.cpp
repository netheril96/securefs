...
TEST_CASE("Test SIV Null Ad")
{
    const byte key[] = {62, 186, 247, 236, 192, 108, 233, 1,   35, 104, 164, 67, 49,  22, 141, 96,
                        58, 166, 74,  198, 110, 11,  33,  103, 74, 152, 59,  7,  171, 33, 136, 196};
    const byte ad[] = {};
    const byte plaintext[]
    ...
    const byte siv[] = {46, 3, 26, 59, 15, 63, 85, 232, 216, 167, 245, 229, 85, 29, 245, 71};
    const byte ciphertext[] = {
        71,  147, 240, 64,  136, 240, 69,  4,   64,  142, 56,  142, 163, 53,  152, 221, 15,  100,
        8,   224, 186, 173, 93,  15,  24,  22,  194, 15,  230, 153, 135, 43,  16,  91,  2,   220,
        232, 157, 124, 97,  130, 224, 236, 251, 68,  167, 218, 85,  62,  244, 12,  9,   198, 154,
        199, 85,  189, 69,  31,  240, 196, 18,  60,  167, 239, 59,  244, 214, 98,  75,  6,   179};
